...
namespace EmlakProject.Controllers
{
    public class MahalleController : Controller
    {
        ...
        {
            ViewBag.SemtId = new SelectList(db.Semts, "SemtId", "SemtName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MahalleId,MahalleName,SemtId")] Mahalle mahalle)
        {
            ...
            ViewBag.SemtId = new SelectList(db.Semts, "SemtId", "SemtName", mahalle.SemtId);
            return View(mahalle);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MahalleId,MahalleName,SemtId")] Mahalle mahalle)
        {
            if (ModelState.IsValid)
            {
